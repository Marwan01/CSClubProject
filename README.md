...
Project worked on in the Computer Science Club of Lindenwood to demonstrate multiple workshops such as using version control, bootstrapping a web app, and deploying to GCP.
